...
<body>
    ...
    <?php
        ...
        foreach($project as $projectDetails){
            ...
            <main id="main" style="background-image:url('<?php echo $projectDetails["projectImage"];?>')">
            <div class="text-container">
                <!-- Fill saved salutation -->
                <h1 class="namen" id="aanhef"><?php echo $projectDetails["projectAanhef"];?></h1>
                <img src="img/line.png">
                <!-- Fill saved welcome text -->
                <h6 id="welkom-tekst"><?php echo $projectDetails["projectTekst"];?></h6>
            </div>
            <!-- Fill saved background color -->
            <div class="gradient" style="background: <?php echo $projectDetails['projectKleur']; ?>; opacity: 0.75;"></div>
            <?php
        }
    ?>
    </main>
